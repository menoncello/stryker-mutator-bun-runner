...
Story is already marked in-progress
  ...
  <step n="4" goal="Run quality gates and validations">
    ...
    <substep n="4.1" goal="TypeScript type checking">
      ...
      <critical>NEVER use 'any' type - violates ADR-004 and NFR018</critical>
    </substep>
    ...
    <substep n="4.5" goal="Mutation testing">
      ...
      <check>Mutation score ≥80% required (high threshold)</check>
      <critical>NEVER lower mutation thresholds - add more tests to kill survivors</critical>
    </substep>
